...
import me.tr.trItems.item.metas.TrMapMeta;
 ...
 */
public class TrMapItem extends TrBaseItem {
    private @Nullable TrMapView mapView;
     ...
     */
    public TrMapItem(TrBaseItem item, @Nullable TrMapView mapView, boolean scaling, @Nullable Color color) {
     ...
     * @return The MapView
     */
    public @Nullable TrMapView getMapView() {
        return mapView;
    }
     ...
     */
    public void setMapView(@Nullable TrMapView mapView) {
        this.mapView = mapView;
    }
    ...
    /**
     * Gets the MapMeta instance from the item stack.
     *
     * @return The MapMeta instance
     */
    @Override
    ...
    public static class Builder extends TrBaseItem.Builder {
        ...
        /**
         * Constructs a new Builder instance for creating a MapItem.
         *
         ...
         */
        public Builder mapView(TrMapView mapView) {
            this.mapView = mapView;
            return this;
        }
         ...
         */
        public TrMapItem build() {
            return new TrMapItem(super.build(), mapView, scaling, color);
        }
    }
}
