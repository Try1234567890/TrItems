...
public class TrEnchants {
     ...
     */
    public TrEnchants(Enchantment enchantment, int level) {
        this.enabled = true;
     ...
     * @param level       The level of the enchantment
     */
    public TrEnchants(boolean enabled, Enchantment enchantment, int level) {
     ...
     */
    public TrEnchants(Enchantment enchantment, int level, boolean override) {
        this.enabled = true;
        this.enchantment = enchantment;
        this.level = level;
     ...
     * @param override    Whether the enchantment should override existing enchantments
     */
    public TrEnchants(boolean enabled, Enchantment enchantment, int level, boolean override) {
        this.enabled = enabled;
        this.enchantment = enchantment;
        this.level = level;
        this.override = override;
    ...
    public String toString() {
        return "Enchants{enabled=" + enabled + ", enchantment=" + enchantment + ", level=" + level + ", override=" + override + '}';
    }
}
