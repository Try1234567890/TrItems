...
public class TrMapLoader extends TrBaseLoader {


    public TrMapItem load(Plugin plugin, Section itemSection) {
        ...
        return new TrMapItem(baseItem, mapView, scaling, color);
    }

    public Color getColor(Section itemSection) {
        String colorStr = itemSection.getString("Color");
        return ColorUtil.parseColor(colorStr);
    }
