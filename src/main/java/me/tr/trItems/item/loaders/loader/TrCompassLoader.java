...
public class TrCompassLoader extends TrBaseLoader {

    public TrCompassItem load(Plugin plugin, Section itemSection) {
        ...
        return new TrCompassItem(baseItem, lodestone, trackLodestone);
    }
